...
// The richer `show` signature adds an optional { persistent, action } options bag
// and returns a handle { id, update, dismiss } so the update checker can flip a
// persistent toast's label to "Downloading… NN%".
