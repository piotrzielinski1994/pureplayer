...
// TC-012 (R15 Task 4). pureplayer must CONSUME the hoisted useActionHotkeys hook
...
// alias, both call sites resolve useActionHotkeys from @pziel/pureui, and the
// app-side registry.ts + resolve.ts stay untouched.

const testDir = dirname(fileURLToPath(import.meta.url));
const srcDir = resolve(testDir, "../../.."); // .../pureplayer/src
...
describe("pureplayer consumes the pureui useActionHotkeys hook (TC-012)", () => {
